...
public class ApplicationManagerClient implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        try {
            ...
            registrationURL = applicationManager.getRegistrationURL(applicationId);

            // Put the application identifier and registration URL in the application scope.
            event.getServletContext().setAttribute(APPLICATION_ID_KEY, applicationId);
            event.getServletContext().setAttribute(REGISTRATION_URL_KEY, registrationURL);
        }
        catch(Exception e) {
            e.printStackTrace();
        }
